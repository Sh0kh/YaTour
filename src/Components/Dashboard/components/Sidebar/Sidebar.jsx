            ...
            <div className="hidden md:block">
                <Card className="h-[95%] w-[280px] fixed top-[15px] left-[15px] z-50 shadow-xl bg-white/30 backdrop-blur-md border border-white/20 px-6 py-6 overflow-y-auto">
                    <div className="flex items-center gap-3 mb-8">
                        <div className="px-[10px] h-10 rounded-full bg-gradient-to-br from-white to-gray-200 shadow-md flex items-center justify-center text-black font-bold text-xl">
                            YaTur
                        </div>
